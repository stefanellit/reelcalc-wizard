...
export const researchDir = path.join(root, 'research/spinning-page-followup');
...
export const baseCommit='9b8a8edd2289c0f26ee848c41f1e4f76ccd84d4f';
...
const manifestFile = 'research/spinning-page-followup/sources.json';
export async function cache(url) {
  ...
  try {
    ...
    const file = `research/spinning-page-followup/sources/${stem}.${pdf ? 'pdf' : 'txt'}`;
...
if (process.argv[1] && path.resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  write('research/spinning-page-followup/inventory.json', {
