...
assert.match(calculatorSource, /data-action="no-backing"/);
assert.match(calculatorSource, /want to use backing/);
assert.match(calculatorSource, /suggestedSetup/);
assert.doesNotMatch(calculatorSource, /applyPracticalMainLineAmount/);
assert.doesNotMatch(calculatorSource, /Backing uses the selected main and backing line diameters/);
...
console.log("- Fixed starting suggestion, no-backing shortcut, and removed backing note passed");
