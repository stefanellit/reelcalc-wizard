(function() {
  ...
  function initialize() {
    ...
    if (lineDetail || /^\/lines(?:\/|$)/.test(location.pathname) ||
        location.pathname.replace(/\/+$/, "") === "/fishing-line-setup-guides") {
    ...
    fetch(assetUrl("data/reel-page-embeds.json?v=13"), { credentials: "omit" })
      ...
      .then(function(manifest) {
        ...
        return Promise.all([
          loadScript("js/reel-page-calculator.js?v=11", "ReelCalcReelPageCalculator"),
